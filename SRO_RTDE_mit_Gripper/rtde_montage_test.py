...
wrench_down = [0, 0, -1, 0, 0, 0]  # Abwärtskraft von `-10 N` entlang der Z-Achse
wrench_up   = [0, 0,  1, 0, 0, 0]  # Aufwärtskraft von `10 N` entlang der Z-Achse
